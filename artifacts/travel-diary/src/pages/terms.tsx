    ...
    <div className="min-h-[100dvh] bg-background">
      ...
      <main className="max-w-2xl mx-auto px-5 py-8 space-y-8 text-sm leading-relaxed text-foreground">
        ...
        <p className="text-muted-foreground">
          欢迎使用红薯旅行日记（以下简称"本应用"或"本服务"）。请在使用本服务前仔细阅读本用户服务协议（以下简称"本协议"）。注册账号或使用本服务即视为您已阅读、理解并同意本协议的全部条款。
        </p>

        <Section title="一、服务说明">
          <p className="text-muted-foreground">
            红薯旅行日记是一款帮助用户记录旅行经历、管理旅行日记和照片、获取 AI 辅助行程规划的移动及网页应用。我们保留随时修改、暂停或终止部分或全部服务的权利，并将提前通知用户。
          </p>
        </Section>
